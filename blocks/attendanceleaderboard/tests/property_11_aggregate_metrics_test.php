 ...
 * @group      block_attendanceleaderboard
 */
class property_11_aggregate_metrics_test extends \advanced_testcase {
    use TestTrait;
    ...
    public function test_property11_average_score_is_arithmetic_mean(): void {
        $this->forAll(
            Generator\vector(
                Generator\choose(1, 20),   // list length: 1 to 20 scores
                Generator\choose(0, 10000) // raw integer 0-10000, divide by 100 → 0.00-100.00
            )
