    ...
    private function get_static_templates(): array {
        return [
            ...
            [
                ...
                'motivation_target'  => 1,
                'content'            => 'Jangan menyerah ya! Setiap langkah kecil membawamu makin dekat ke tujuan belajarmu.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // recovery × Middle
            [
                ...
                'motivation_target'  => 1,
                'content'            => 'Kamu punya potensi yang luar biasa! Teruslah berusaha, proses belajarmu pasti membuahkan hasil manis.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // recovery × High
            [
                ...
                'motivation_target'  => 1,
                'content'            => 'Wajar kok kalau sesekali ada kesulitan. Jadikan pengalaman ini batu loncatan agar kamu makin jago!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // persistence × Low
            [
                ...
                'performance_target' => 1,
                'motivation_target'  => 2,
                'content'            => 'Ketekunanmu adalah kunci keberhasilan. Tetap semangat belajar ya, sedikit demi sedikit pasti bisa!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // persistence × Middle
            [
                ...
                'performance_target' => 2,
                'motivation_target'  => 2,
                'content'            => 'Konsistensi belajarmu keren banget! Terus pertahankan ritme ini agar kemampuanmu makin terasah.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // persistence × High
            [
                ...
                'performance_target' => 3,
                'motivation_target'  => 2,
                'content'            => 'Pertahankan semangat belajarmu ya! Usaha konsisten yang kamu lakukan akan berbuah manis.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // reinforcement × Low
            [
                ...
                'performance_target' => 1,
                'motivation_target'  => 2,
                'content'            => 'Kamu sudah menunjukkan kemajuan yang nyata! Terus eksplorasi dan latihan agar makin percaya diri.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            ...
            [
                ...
                'performance_target' => 2,
                'motivation_target'  => 2,
                'content'            => 'Kerja kerasmu mulai kelihatan hasilnya nih! Pertahankan semangat belajarmu ya!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // reinforcement × High
            [
                ...
                'performance_target' => 3,
                'motivation_target'  => 2,
                'content'            => 'Prestasimu membanggakan banget! Terus tantang dirimu untuk hal-hal seru berikutnya ya!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // achievement × Low
            [
                ...
                'performance_target' => 1,
                'motivation_target'  => 3,
                'content'            => 'Selamat atas pencapaianmu! Ini bukti nyata kalau usaha dan kerja kerasmu selalu membuahkan hasil.',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // achievement × Middle
            [
                ...
                'performance_target' => 2,
                'motivation_target'  => 3,
                'content'            => 'Pencapaianmu hari ini adalah langkah awal yang mantap. Terus berkarya dan berprestasi ya!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
            // achievement × High
            [
                ...
                'performance_target' => 3,
                'motivation_target'  => 3,
                'content'            => 'Luar biasa! Kamu berhasil meraih hasil terbaik. Keren banget, jadilah inspirasi buat teman-temanmu ya!',
                'language'           => 'id',
                'source'             => self::SOURCE_TEMPLATE,
            ],
        ];
